    ...
    <source src="/images/background.mp4" type="video/mp4" />
        ...
        <div className="relative z-10 w-full max-w-lg mx-4 backdrop-blur-lg bg-white/10 border border-white/20 rounded-2xl shadow-2xl px-12 py-12">
          <div className="text-center mb-10">
            <h2 style={{ fontFamily: 'var(--font-manrope)' }} className="text-4xl font-light text-white mb-3 tracking-wide">Create Account</h2>
            <p style={{ fontFamily: 'var(--font-nunito)' }} className="text-white/70 text-sm">Join us today and get started</p>
          </div>
